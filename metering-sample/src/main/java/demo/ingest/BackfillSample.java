...
public class BackfillSample {
    private final static String METER_NAME = "ApiCalls";
    private final static int METER_VALUE = 3;
    private final static String CUSTOMER_ID = "auth0-61c49416eab084006aa23f62";
    ...
    public static void main(final String[] args) throws Exception{
        MeteringContext.createOrReplaceContext("86998bf0-1713-11ec-ac24-bd2828401aff", "myApp", Domain.Prod,Region.US_West, 1, 10);

        // Mongodb initialization parameters.
        int port_no = 27017;
        String host_name = "localhost", db_name = "sample_mflix", db_coll_name = "comments";
    
        // Mongodb connection string.
        String client_url = "mongodb://demo2:demo2@cluster0-shard-00-00.iietw.mongodb.net:27017,cluster0-shard-00-01.iietw.mongodb.net:27017,cluster0-shard-00-02.iietw.mongodb.net:27017/myFirstDatabase?ssl=true&replicaSet=atlas-t88b5j-shard-0&authSource=admin&retryWrites=true&w=majority";
        ...
        MongoCollection<Document> col = db.getCollection(db_coll_name);
        ...
        try {
            while(cursor.hasNext()) {     
                ...
                //metering().meter(CUSTOMER_ID, METER_NAME, METER_VALUE, EVENT_TIME, EXTRA_DIMENSIONS_MAP);
            }
        } finally {
            cursor.close();
        }
